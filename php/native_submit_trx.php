<?php
    ...
    try{
        $url = "https://api-dev.plink.co.id/gateway/v2/payment/integration/transaction/api/submit-trx"; // url for of plink system. ex. https://secure2-staging.plink.co.id for staging environment
        ...
        if($result->response_code === "PL000" || $result->response_code === "MBDD00"){
            ...
            $paymentpage_enpoint = $result->payment_page_url;
            // redirect to payment page
            $paymentpage_url = "https://secure2-staging.plink.co.id".$paymentpage_enpoint;
            header('location:'.$paymentpage_url);
