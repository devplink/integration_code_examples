<?php
    ...
    $url = "https://api-dev.plink.co.id/gateway/v2/payment/integration/transaction/api/inquiry-transaction"; // url for of plink system. ex. https://secure2-staging.plink.co.id for staging environment
